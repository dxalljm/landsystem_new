...
//        }
        ...
        if(isset($params['Plantingstructureyearfarmsidplan']['management_area'])) {
            if($params['Plantingstructureyearfarmsidplan']['management_area'] == 0)
                $this->management_area = NULL;
            else
                $this->management_area = $params['Plantingstructureyearfarmsidplan']['management_area'];
        } else {
