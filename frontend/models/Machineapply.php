...
class Machineapply extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['farms_id', 'age', 'management_area', 'machineoffarm_id','create_at','update_at','state','dckstate','year'], 'integer'],
    ...
    {
        $processRows = Machineapply::find()->where(['state'=>0,'year'=>User::getYear()])->count();
