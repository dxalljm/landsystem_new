...
// 		LODOP.SET_PRINT_PAGESIZE(2,'297mm','210mm');
        LODOP.ADD_PRINT_TBURL(86,16,1078,88,"index.php?r=print/farminfotable&farms_id="+<?= $farm['id']?>);
        LODOP.ADD_PRINT_TBURL(166,16,1078,763,"index.php?r=print/hstable&farms_id="+<?= $farm['id']?>);
        LODOP.ADD_PRINT_TBURL(615,16,1078,863,"<?= Url::to(['print/hsdowntable'])?>");
        LODOP.ADD_PRINT_TEXT(30,320,657,33,"<?= User::getYear()?>年岭南生态示范区农业基础数据核实表");
        LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
        LODOP.SET_PRINT_STYLEA(0,"Bold",1);
        LODOP.ADD_PRINT_TEXT(66,20,341,24,"管理区：<?= ManagementArea::getNowManagementareaName()?>");
        LODOP.SET_PRINT_STYLEA(0,"FontSize",14);
        LODOP.SET_PRINT_STYLEA(0,"Bold",1);
        LODOP.ADD_PRINT_TEXT(66,980,160,25,"单位：亩");
        LODOP.SET_PRINT_STYLEA(0,"FontSize",14);
        LODOP.SET_PRINT_STYLEA(0,"Bold",1);
        LODOP.ADD_PRINT_TEXT(730,1048,160,25,"<?= $farm['farmerpinyin']?>");
...
//			LODOP.SET_PRINT_PAGESIZE('2','297mm','210mm');
        LODOP.ADD_PRINT_TBURL(86,16,1078,88,"index.php?r=print/farminfotable&farms_id="+farms_id);
        LODOP.ADD_PRINT_TBURL(166,16,1078,763,"index.php?r=print/hstable&farms_id="+farms_id);
        LODOP.ADD_PRINT_TBURL(615,16,1078,863,"<?= Url::to(['print/hsdowntable'])?>");
        LODOP.ADD_PRINT_TEXT(30,320,657,33,"<?= User::getYear()?>年岭南生态示范区农业基础数据核实表");
        LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
        LODOP.SET_PRINT_STYLEA(0,"Bold",1);
        ...
        LODOP.SET_PRINT_STYLEA(0,"FontSize",14);
        LODOP.SET_PRINT_STYLEA(0,"Bold",1);
        LODOP.ADD_PRINT_TEXT(730,1048,160,25,farmerpinyin);
        LODOP.SET_SHOW_MODE("LANDSCAPE_DEFROTATED",1);
        LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
        LODOP.SET_PRINT_STYLEA(0,"Bold",1);
    };
