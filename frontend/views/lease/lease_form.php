...
<?php //$farms = Farms::find()->where(['id'=>$_GET['farms_id']])->one();?>
  ...
  <tr>
    ...
    <td width="15%" align="center"><?= $form->field($model, 'lessee')->textInput()->label(false)->error(false) ?></td>
    <td width="8%" align="right"><strong>身份证号</strong></td>
    <td width=""><?= $form->field($model, 'lessee_cardid')->textInput()->label(false)->error(false) ?></td>
