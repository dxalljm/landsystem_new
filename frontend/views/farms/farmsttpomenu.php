              ...
              <div class="row">
                <div class="col-sm-6 border-right">
                  <div class="description-block">
                      <?php if(Farms::isFarmsInfo($farms_id) or User::disabled()) echo html::a('<h1>整体转让</h1>','#',['class'=>'btn btn-block btn-info btn-lg','disabled'=>User::disabled()]);else echo html::a('<h1>整体转让</h1>',Url::to(['farms/farmsttpowhole','farms_id'=>$farms_id]),['class'=>'btn btn-block btn-info btn-lg'])?>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                  <div class="description-block">
                      <?php if(Farms::isFarmsInfo($farms_id) or User::disabled()) echo html::a('<h1>部分转让</h1>','#',['class'=>'btn btn-block btn-info btn-lg','disabled'=>User::disabled()]);else echo html::a('<h1>部分转让</h1>',Url::to(['farms/farmsttpopart','farms_id'=>$farms_id]),['class'=>'btn btn-block btn-info btn-lg'])?>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
