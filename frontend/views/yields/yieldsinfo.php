...
//                                    var_dump($type);
                ...
                <div class='tab-pane' id="plantingstructureDataLast">
                    <div id="plantingstructuredataLast" style="width:1000px; height: 600px; margin: 0 auto"></div>
                    <?php $dataLast->getName('Plant', 'typename', 'plant_id')->typenameList();?>
                </div>
                <script type="text/javascript">
                    showAllShadow('plantingstructuredataLast',<?= json_encode(Farms::getManagementArea('small')['areaname'])?>,<?= json_encode($dataLast->getName('Plant', 'typename', 'plant_id')->typenameList())?>,<?= $dataLast->getName('Plant', 'typename', 'plant_id')->showAllShadow('mulyieldSum',['area', 'plant_id']);?>,'斤');
                </script>
                <!-- /.tab-pane -->
                ...
                <?php if($data->getName('Goodseed', 'typename', 'goodseed_id')->getList()) {?>
                    ...
                    <script type="text/javascript">
                        showAllShadow('goodseedinfoLast',<?= json_encode(Farms::getManagementArea('small')['areaname'])?>,<?= json_encode($dataLast->getName('Goodseed', 'typename', 'goodseed_id')->typenameList())?>,<?= $dataLast->getName('Goodseed', 'typename', 'goodseed_id')->showAllShadow('mulyieldSum',['area', 'plant_id',]);?>,'斤');
                    </script>
                <?php }?>
<!--                当年信息-->
