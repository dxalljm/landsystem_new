...
class Insuranceplan extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['management_area', 'farms_id', 'create_at', 'update_at', 'policyholdertime', 'managemanttime', 'halltime', 'state', 'fwdtstate', 'issame', 'isselfselect', 'nameissame', 'isbxsame', 'iscontractarea', 'farmstate', 'lease_id'], 'integer'],
